...
export default function Button({ children, ...props }: ButtonProps) {
  ...
  return (
    <El
      ...
      className={`outline-1 outline ${props.disabled ? "bg-gray-300" : "bg-blue-300 hover:bg-blue-600"} outline-blue-950 text-gray-950 gap-2 px-2 py-0.5 transition-colors rounded flex flex-row items-center  ${props.className}`}
    >
