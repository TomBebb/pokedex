...
export default function Button({ children, ...props }: ButtonProps) {
  ...
  return (
    <El
      ...
      className={`outline-1 outline ${props.disabled ? `bg-${style}-300 text-black` : `bg-${style} text-${style}-content hover:bg-${style}-600`} outline-blue-950 gap-2 px-2 py-0.5 transition-colors rounded flex flex-row items-center ${props.className}`}
    >
