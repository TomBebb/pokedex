...
<template>
  <div class="flex flex-col">
    <div
      class="border-gray-700 bg-white top-[6vh] flex flex-col items-center border-b-2 pl-3 lg:sticky lg:flex-row lg:z-1 h-[6vh]">
    ...
    <Accordion title="Abilities">
      <div class="flex flex-col gap-2 p-3 z-[-2]">
